...
public class MainBottomTabLayout extends LinearLayout {
    ...
    private String mTitles[] = {"查词", "翻译", "学习"};
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextNormalColor = getResources().getColor(R.color.bottom_tab_text_color_normal);
        mTextSelectedColor = getResources().getColor(R.color.bottom_tab_text_color_selected);
    }
