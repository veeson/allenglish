    ...
    private void initRecyclerView() {
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(mContext, ComprehensionEnglishActivity.class);
    ...
    private void fetchComprehensionFromInternet(String date, int limit, int skip) {
        ...
        VolleySingleton.getInstance(mContext)
                .addToRequestQueue(new GsonRequest<>("https://leancloud.cn:443/1.1/classes/Comprehension?where={\"postTime\":{\"$lte\":{\"__type\":\"Date\",\"iso\":\"" + date + "\"}}}&limit=" + limit + "&skip=" + skip + "&order=-postTime"
                    ...
                    @Override
                    public void onErrorResponse(VolleyError error) {Toast.makeText(ComprehensionActivity.this, R.string.error_loading, Toast.LENGTH_SHORT).show();
