...
public class WordActivity extends AppCompatActivity {
    ...
    private void fetchComprehensionFromInternet(String date, int limit, int skip) {
        ...
        VolleySingleton.getInstance(mContext)
                .addToRequestQueue(new GsonRequest<>("https://leancloud.cn:443/1.1/classes/Word?where={\"postTime\":{\"$lte\":{\"__type\":\"Date\",\"iso\":\"" + date + "\"}}}&limit=" + limit + "&skip=" + skip + "&order=-postTime"
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WordActivity.this, R.string.error_loading, Toast.LENGTH_SHORT).show();
